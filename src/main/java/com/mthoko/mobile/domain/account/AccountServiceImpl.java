...
import com.mthoko.mobile.domain.account.credentials.Credentials;
import com.mthoko.mobile.domain.account.credentials.CredentialsService;
import com.mthoko.mobile.domain.account.member.Member;
import com.mthoko.mobile.domain.account.member.MemberService;
import com.mthoko.mobile.domain.devcontact.DevContactService;
import com.mthoko.mobile.domain.device.Device;
import com.mthoko.mobile.domain.device.DeviceService;
import com.mthoko.mobile.domain.simcard.SimCard;
import com.mthoko.mobile.domain.simcard.SimCardService;
import com.mthoko.mobile.domain.simcontact.SimContactService;
import com.mthoko.mobile.domain.sms.SmsService;
